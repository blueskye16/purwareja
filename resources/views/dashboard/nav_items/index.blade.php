            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul
                    ...
                    <li class="group relative inline-flex group border-dotted border-2 border-gray-700 w-20 cursor-pointer">
                      <div class="absolute inline-flex -top-2 -end-2 w-6 h-6"><i data-feather="plus" class="bg-blue-700 group-hover:bg-blue-900 text-white p-0.5 text-xs font-bold rounded-full"></i></div>
                    </li>
