                ...
                <form class="p-4 md:p-5" method="POST" action="/dashboard/users">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 ">
                            ...
                            <div class="flex">
                                <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700 w-[50%] m-2 ml-0">
                                    <input id="role" type="radio" value="1" name="role"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="role"
                                        class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Super Admin</label>
                                </div>
                                <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700 w-[50%] m-2 mr-0">
                                    <input checked id="role" type="radio" value="0" name="role"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="role"
